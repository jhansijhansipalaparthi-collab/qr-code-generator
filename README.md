# QR Code Generator 
Python tool to generate QR codes from user details. Built for  quickly capture customer information.
...
# QR code Use Case
Instead of typing long details manually,users can share info via QR code quickly
